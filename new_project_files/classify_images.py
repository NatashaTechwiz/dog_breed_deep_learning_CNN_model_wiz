...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # Convert the value associated with the key to a list if it's a string
        if isinstance(results_dic[key], str):
        ...
        print(f"Key: {key} - Model Label: {model_label}, Match Status: {1 if truth in model_label else 0}")
