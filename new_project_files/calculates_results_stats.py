...
#          This function puts the results statistics in a dictionary
#          (results_stats_dic) that's created and returned by this function.
#          
#          This will allow the user of the program to determine the 'best' 
#          model for classifying the images. The statistics are calculated
...
#
##
# Function calculates_results_stats 
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_correct_breed'] = 0 # Count to be updated by calculation, not loop
    ...
    for key in results_dic:
        ...
        # Labels Match Exactly between pet & classifier labels
        ...
        if results_dic[key][3] == 1:
            ...
            # Second if statement is specifically related to the first if condition being met
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1

                # Check if pet image label and classifier label are the same for dog images
                if results_dic[key][2] == 1:
    ...
    # Uses conditional statements to check denomenator
