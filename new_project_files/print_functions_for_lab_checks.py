...
#                                                                             
# PROGRAMMER: Jennifer S.  / Natasha                                                  
# DATE CREATED: 05/14/2018                                  
# REVISED DATE: Natasha 25apr24 - code added to output check for % correct matches
#               any code added is described and initialled NS                       
...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        print("N Images: {:2d}  N Dog Images: {:2d}  N NotDog Images: {:2d} \nPct Corr dog: {:5.1f} Pct Corr NOTdog: {:5.1f}  Pct Corr Breed: {:5.1f} Pct Match NS: {:5.1f}".format(
              ...
              results_stats_dic['pct_correct_breed'], results_stats_dic['pct_match']))
        print("\n ** Check Statistics - calculated from this function as a check:")
        print("N Images: {:2d}  N Dog Images: {:2d}  N NotDog Images: {:2d} \nPct Corr dog: {:5.1f} Pct Corr NOTdog: {:5.1f}  Pct Corr Breed: {:5.1f} Pct Match NS: {:5.1f}".format(
              n_images, n_pet_dog, n_pet_notd, pct_corr_dog, pct_corr_notdog,
              pct_corr_breed, pct_match))
